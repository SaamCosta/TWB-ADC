help_file = {
    ...
    'premium_exchange.max_rate_per_point': 'Only sell while the exchange asks at most this many resources for 1 Premium Point. Lower is stricter. The floor early in a world is around 66, rises to ~90 over the first days and past 800 once the exchange stock fills up — see docs/troca_premium.md',
